...
var App = {
	...
	sliderInit: function() {
		...
		if($('#carousel').length) {
			$.mbBgndGallery.buildGallery({
				...
				images:[
					"https://multinegocios.com.ec/images/banners/viajemos.jpg",
					"https://multinegocios.com.ec/images/mano.jpg",
					"https://multinegocios.com.ec/images/rostro.jpg",
					"https://multinegocios.com.ec/images/home911.jpg"
				]
	...
	create_map: function(mapContainer) {
		...
		var mapOptions = {
			...
			center: new google.maps.LatLng(-0.301943, -78.347017), //37.36456, -121.92852
			zoom: 13,
	...
	create_marker: function() {
		...
		myPin = new google.maps.LatLng(-0.331943, -78.447017);
